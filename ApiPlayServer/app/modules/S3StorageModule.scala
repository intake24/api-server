...
import uk.ac.ncl.openlab.intake24.services.fooddb.images.{ImageStorageS3, ImageStorageService, S3ImageStorageSettings}

class S3StorageModule extends AbstractModule {

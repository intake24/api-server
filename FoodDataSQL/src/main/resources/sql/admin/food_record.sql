...
SELECT v.food_code, v.locale_id, code, description, local_description, food_group_id,
       same_as_before_option, ready_meal_option, reasonable_amount, use_in_recipes, foods.version as version,

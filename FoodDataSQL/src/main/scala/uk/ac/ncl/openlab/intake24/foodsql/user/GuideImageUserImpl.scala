...
import uk.ac.ncl.openlab.intake24.services.fooddb.user.{GuideImageService, GuideImageV2}
...
trait GuideImageUserImpl extends GuideImageService with FoodDataSqlService with SqlResourceLoader {
  ...
  def getGuideImage(id: String): Either[LookupError, GuideImageV2] = tryWithConnection {
    implicit conn =>
        ???
/*

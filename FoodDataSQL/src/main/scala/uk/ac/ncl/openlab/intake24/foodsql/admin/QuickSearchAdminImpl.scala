...
@Singleton
class QuickSearchAdminImpl @Inject()(@Named("intake24_foods") val dataSource: DataSource) extends QuickSearchService with SqlDataService with HeaderRows with SqlResourceLoader {

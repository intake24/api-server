...
public class CrowdflowerFinalPage implements SurveyStage<Survey> {
	...
	private final static HtmlResources resources = HtmlResources.INSTANCE;

	private final String finalPageHtml;
	private final Survey data;
	private final List<String> log;

	public CrowdflowerFinalPage(Survey data, List<String> log) {
		this.finalPageHtml = resources.getFinalHtml().getText();
		this.data = data;
		this.log = log;
	}

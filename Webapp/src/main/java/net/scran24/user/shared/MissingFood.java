...
public class MissingFood extends FoodEntry {
	...
	public MissingFood(FoodLink link, String name, boolean isDrink, Option<MissingFoodDescription> description, PSet<String> flags, PMap<String, String> customData) {

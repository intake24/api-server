...
abstract class ArabicFoodIndex(foodData: FoodIndexDataService, locale: String)
  extends AbstractFoodIndex(foodData, None, new ArabicWordOpsImpl(), ArabicFoodIndex.indexFilter,
    ArabicFoodIndex.nonIndexedWords, ArabicFoodIndex.specialFoodNames, locale)

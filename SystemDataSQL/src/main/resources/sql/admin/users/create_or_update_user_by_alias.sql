...
INSERT INTO users (id, password_hash, password_salt, password_hasher, name, email, phone)
  SELECT user_id, {password_hash}, {password_salt}, {password_hasher}, {name}, {email}, {phone} FROM a

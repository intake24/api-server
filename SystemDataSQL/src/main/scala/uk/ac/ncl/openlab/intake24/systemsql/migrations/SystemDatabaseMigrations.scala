...
object SystemDatabaseMigrations {
  ...
  val activeMigrations: Seq[Migration] = Seq(
    ...
    new Migration {
      ...
      override val description: String = "Create en_GB_gf local nutrients list from en_GB"

      override def apply(logger: Logger)(implicit connection: Connection): Either[MigrationFailed, Unit] = {
        SQL("INSERT INTO local_nutrient_types(locale_id, nutrient_type_id) SELECT 'en_GB_gf', nutrient_type_id FROM local_nutrient_types WHERE locale_id='en_GB'").execute()
    ...
    new Migration {
      ...
      override def apply(logger: Logger)(implicit connection: Connection): Either[MigrationFailed, Unit] = {
        SQL(
          """
            |ALTER TABLE surveys ADD COLUMN feedback_style character varying(50) NOT NULL DEFAULT 'default';
            |UPDATE surveys SET feedback_style='playful' WHERE id='newcastle-can';
            |""".stripMargin).execute()
    ...
    new Migration {
      ...
      override def apply(logger: Logger)(implicit connection: Connection): Either[MigrationFailed, Unit] = {
        ...
        SQL("INSERT INTO local_nutrient_types(locale_id, nutrient_type_id) SELECT 'en_NZ_2', nutrient_type_id FROM local_nutrient_types WHERE locale_id='en_GB'").execute()
    ...
    new Migration {
      ...
      override val versionFrom: Long = 85l
      override val versionTo: Long = 86l
    ...
    new Migration {
      ...
      override val versionFrom: Long = 86l
      override val versionTo: Long = 87l
      override val description: String = "Add editable final page HTML"

      override def apply(logger: Logger)(implicit connection: Connection): Either[MigrationFailed, Unit] = {
        SQL("alter table surveys add column final_page_html varchar(10000)").execute()

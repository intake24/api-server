...
class MilkInHotDrinkPortionSizeEditor(params: Seq[PortionSizeMethodParameter], changesMade: () => Unit) extends PortionSizeEditor {
  ...
  val methodName = "milk-in-a-hot-drink"
}
...
case class SigninAttempt(remoteAddress: String, userAgent: Option[String], provider: String, providerKey: String, success: Boolean, userId: Option[Long], message: Option[String])
